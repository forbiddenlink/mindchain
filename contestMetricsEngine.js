...
const contestMetricsEngine = new ContestMetricsEngine();
export default contestMetricsEngine;

// Helper functions for server integration
export async function startContestMetrics() {
    return await contestMetricsEngine.startContestMetricsCollection();
}

export async function getLiveContestMetrics() {
    return await contestMetricsEngine.getLiveContestMetrics();
}
